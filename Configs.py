...
class MAXSwerveModule:
    ...
    drivingConfig.closedLoop.setFeedbackSensor = SparkMaxConfig.FeedbackSensor.kEncoder
    ...
    turningConfig.closedLoop.setFeedbackSensor = SparkMaxConfig.FeedbackSensor.kAbsoluteEncoder
